    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Capturing moments through a lens.", null, "Photography" },
                    { 2, "Writing code to solve problems.", null, "Programming" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "https://alicephotos.com" },
                    { 2, 2, 2, "https://bobcodes.io" }
                });
